    ...
    <div class="d-flex">
        ...
        <div class="w-100">
            ...
            <div class="" id="content">
                ...
                <section>
                    <div class="container">
                        <h1 class="font-weight-bold mb-0 py-2">Registrar organizadores</h1>
                        <div class="pb-3">
                            <button id="btnNuevo" type="button" class="btn btn-success">Nuevo organizador</button>
                        </div>
                    </div>
                    <div class="container">
                        <div class="row">
                                ...
                                <div class="table-responsive">
                                    <table id="tabla" class="table table-striped table-bordered table-condensed" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            $query = "SELECT * FROM organizador where idPukllay='$idPukllay'";
                                            ...
                                            ?>
                                            <tr>
                                                <td><?php echo $data['dniOrg'] ?></td>
                                                <td><?php echo $data['nombreOrg'] ?></td>
                                                <td><?php echo $data['ApellidoOrg'] ?></td>
                                                <td><?php echo $data['ocupacionorg'] ?></td>
                                                <td><?php echo $data['telefonoOrg'] ?></td>
                                                <td><?php echo $data['correoOrg'] ?></td>
                                                <td></td>
                                            </tr>
                                            <?php
                                            }
...
-->
    ...
    <script src="js/jsoperarioprorganizadores.js"></script>
