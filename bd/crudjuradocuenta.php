    ...
    isset($_POST['dirrecion']))
{
    ...
    $consulta = "UPDATE jurado set nombJurado='$nombre',apelJurado='$apellido',celuJurado='$celular',coreJurado='$Correo',direJurado='$dirrecion' where dniJurado='$dniUsuario'";
    $resultado = $conexion->prepare($consulta);
    $resultado->execute(); 

    $consulta = "SELECT * FROM jurado where dniJurado='$dniUsuario'";
    $resultado = $conexion->prepare($consulta);
    $resultado->execute();
