    ...
    <div class="d-flex">
        <div id="sidebar-container" class="bg-primary">
            ...
            <div class="menu">
                ...
                <a href="" class="d-block p-3 text-light"><i class="icon ion-md-eye mr-2 lead"></i>Visualizar puntaje</a>
                <a href="" class="d-block p-3 text-light"><i class="icon ion-md-eye mr-2 lead"></i>Visualizar comentarios</a>
                <a href="" class="d-block p-3 text-light"><i class="icon ion-md-eye mr-2 lead"></i>Visualizar ranking</a>
            </div>
        </div>
        <div class="w-100">
