    ...
    <div class="d-flex">
        ...
        <div class="w-100">
            ...
            <div class="" id="content">
                <section>
                    <div class="container">
                        <h1 class="font-weight-bold mb-0 py-3">Visualizar puntaje</h1>
                    </div>
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                    ...
                                    <table id="tabla" class="table table-striped table-bordered table-condensed" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $data['puntajeCalificacion'] ?></td>
                                                <td><?php echo $data['descripcionCalificacion'] ?></td>
                                                <td><?php echo $data['lugarCalificacion'] ?></td>
