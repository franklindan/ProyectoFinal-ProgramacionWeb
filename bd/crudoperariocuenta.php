    ...
    isset($_POST['dirrecion']))
{
    ...
    $consulta = "UPDATE operario set nombOper='$nombre',apelOper='$apellido',celuOper='$celular',coreOper='$Correo',direOper='$dirrecion' where dniOper='$dniUsuario'";
    $resultado = $conexion->prepare($consulta);
    $resultado->execute(); 

    $consulta = "SELECT * FROM operario where dniOper='$dniUsuario'";
    $resultado = $conexion->prepare($consulta);
    $resultado->execute();
