    ...
    <div class="d-flex">
        ...
        <div class="w-100">
            ...
            <div class="" id="content">
                ...
                <section>
                    <div class="container">
                        <h1 class="font-weight-bold mb-0 py-2">Registrar premios del Pukllay</h1>
                        <div class="pb-3">
                            <button id="btnNuevo" type="button" class="btn btn-success">Nuevo premio</button>
                        </div>
                    </div>
                    <div class="container">
                        <div class="row">
                                ...
                                <div class="table-responsive">
                                    <table id="tabla" class="table table-striped table-bordered table-condensed" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            $query = "SELECT * FROM premio where pukllay_idPukllay='$idPukllay'";
                                            ...
                                            ?>
                                            <tr>
                                                <td><?php echo $data['idPremio'] ?></td>
                                                <td><?php echo $data['nombrePremio'] ?></td>
                                                <td><?php echo $data['tipoPremio'] ?></td>
                                                <td><?php echo $data['puestoPremio'] ?></td>
                                                <td><?php echo $data['descripcionPremio'] ?></td>
                                                <td></td>
                                            </tr>
                                            <?php
                                            }
                            ...
                            <form id="formModal" method="post">
                                <div class="modal-body">
                                    <div class="form-group etapaH">
                                        <label for="nombrePremio" class="col-form-label">Nombre premio:</label>
                                        <input type="text" class="form-control" id="nombrePremio">
                                    </div>
                                    <div class="form-group">
                                        <label for="tipoPremio" class="col-form-label">Tipo de premio:</label>
                                        <input type="text" class="form-control" id="tipoPremio">
                                    </div>
                                    <div class="form-group">
                                        <label for="puestoPremio" class="col-form-label">Puesto otorgado:</label>
                                        <input type="text" class="form-control" id="puestoPremio">
                                    </div>
                                    <div class="form-group">
                                        <label for="descripcionPremio" class="col-form-label">Descripción del premio:</label>
...
-->
    ...
    <script src="js/jsoperarioprpremios.js"></script>
