    ...
    <div class="d-flex">
        ...
        <div class="w-100">
            ...
            <div class="" id="content">
                <section>
                    <div class="container">
                        <h1 class="font-weight-bold mb-0 py-2">Registrar usuario final indirecto</h1>
                        <div class="row pb-2">
                           <div class="col-lg-4">
                            ...
                            <div class="col-lg-8">
                                <button id="btnNuevo" type="button"class="btn btn-success">Registrar usuario final indirecto</button>
                            </div>
                        </div>
                    </div>
                    <div class="container">
...
-->
    ...
    <script src="js/jsaregistrarusuariofinal.js"></script>
</body>
</html>