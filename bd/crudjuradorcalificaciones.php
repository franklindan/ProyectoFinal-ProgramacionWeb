...
switch($opcion){
    case 1: 
        ...
        break;
    case 2: 
        $consulta = "UPDATE calificacion SET puntajeCalificacion='$puntajeCalificacion', descripcionCalificacion='$descripcionCalificacion' WHERE dniJurado='$dniJurado' and comparsa_idComparsa='$comparsa_idComparsa' and lugarCalificacion='$lugarCalificacion' and etapa_fechaDia='$etapa_fechaDia'";	
        $resultado = $conexion->prepare($consulta);
        $resultado->execute();        
