    ...
    isset($_POST['dirrecion']))
{
    ...
    $consulta = "UPDATE administrador set nombreAdmi='$nombre',apelAdmi='$apellido',celuAdmi='$celular',coreAdmi='$Correo',direAdmi='$dirrecion' where dniAdministrador='$dniUsuario'";
    $resultado = $conexion->prepare($consulta);
    $resultado->execute(); 

    $consulta = "SELECT * FROM administrador where dniAdministrador='$dniUsuario'";
    $resultado = $conexion->prepare($consulta);
    $resultado->execute();
